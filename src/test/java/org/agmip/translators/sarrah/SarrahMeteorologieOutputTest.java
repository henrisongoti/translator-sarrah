 ...
 * @author Meng Zhang
 */
public class SarrahMeteorologieOutputTest {

    SarrahMeteorologieOutput output;
//    SarrahMeteorologieInput input;
    URL resource;

    @Before
    public void setUp() throws Exception {
        output = new SarrahMeteorologieOutput();
//        input = new SarrahMeteorologieInput();
    }
