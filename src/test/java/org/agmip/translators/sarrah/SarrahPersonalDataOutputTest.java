 ...
 * @author Meng Zhang
 */
public class SarrahPersonalDataOutputTest {

    SarrahPersonalDataOutput output;
//    SarrahPersonalDataInput input;
    URL resource;

    @Before
    public void setUp() throws Exception {
        output = new SarrahPersonalDataOutput();
//        input = new SarrahPersonalDataInput();
    }
